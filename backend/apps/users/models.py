...
from config.constants import USER_STATUS, USER_ROLE, USER_PERMISSION
...
class User(models.Model):
    ...
    permission = models.CharField(
        'Permission', blank=False, null=False, choices=USER_PERMISSION, max_length=50, default='normal'
    )
