...
import { adminPermissionOptions, adminRoleOptions } from '../../constants';
                        ...
                        <TableBody>
                            {admins.results.map(user => (
                                <StyledTableRow key={user.id}>
                                    ...
                                    <StyledTableCell align="center">
                                        {getValueOption(adminPermissionOptions, user.permission)}
                                    </StyledTableCell>
                                    <StyledTableCell align="center">
                                        {getDateFormat({ date: user.created_at })}
                                    </StyledTableCell>
